...
Q_force = - F*((A.v)*sin(A.delta)+A.h+A.s)*sin(theta);  % Potential energy as a function of theta (approx)
% Q_force = - F*(A.ActualForceLocation)*sin(theta);  % Potential energy as a function of theta (approx)
